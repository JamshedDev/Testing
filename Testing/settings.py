...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-x(tksfvm-m-%tb@7_l$edvw1y&*e6=&!)#mc=q5ch*7=7y*@ep')
...
# For Vercel: Use in-memory database since filesystem is ephemeral
